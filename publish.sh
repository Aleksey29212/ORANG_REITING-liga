...
if [ -z "$REPO_URL" ]; then
  ...
  echo "Пример: npm run github-push -- https://github.com/Aleksey29212/ORANG_REITING-liga.git"
  exit 1
fi
...
# Процесс коммита
git add .
git commit -m "DartBrig Pro: полная настройка системы и дизайна"
...
echo "📤 Отправка файлов в $REPO_URL..."
# Используем force чтобы гарантированно обновить репозиторий вашим кодом
git push -u origin main --force

echo ""
echo "✨ ГОТОВО! Ваш проект теперь на GitHub."
